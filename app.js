...
const WORDS = {
  ...
  "10": [
    ...
    "convert","couple","credit","culture","cycle",
    "data","decade","drama","edit","error","ethic","expert","resource",
    ...
    "major","margin","mental","method","migrate",
    ...
    "prospect","publish","purchase","random",
  ...
  "01": [
    ...
    "create","domain","emerge","enforce","ensure","equate",
    ...
    "require","reside","resolve","respond",
  ...
  "100": [
    ...
    "interval","liberal","manual","maximise","media",
    ...
    "qualify","radical","ratio","rational","register","regulate",
    "simulate","specify","strategy","subsidy","summarise",
    "summary","supplement","technical","terminate",
    "ultimate","unify","uniform","video","visual"
  ],
  ...
  "010": [
    ...
    "convention","creation","departure",
    "depression","dimension","disposal","distinguish",
    "domestic","donation","dynamic","edition",
    "enable","encounter","enormous","equipment","establish",
